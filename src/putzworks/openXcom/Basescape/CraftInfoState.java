...
public class CraftInfoState extends State
{
	private Base _base;
	private int _craft;

	private TextButton _btnOk, _btnW1, _btnW2, _btnCrew, _btnEquip, _btnArmor;
	private Window _window;
	private Text _txtCraft, _txtDamage, _txtFuel;
	private Text _txtW1Name, _txtW1Ammo, _txtW1Max, _txtW2Name, _txtW2Ammo, _txtW2Max;
	private Surface _sprite, _weapon1, _weapon2, _crew, _equip;
 ...
 */
public CraftInfoState(Game game, Base base, int craft)
{
	super(game);
	_base = base;
	_craft = craft;
 ...
 * @param action Pointer to an action.
 */
public void btnW1Click(Action action)
{
 ...
 * @param action Pointer to an action.
 */
public void btnW2Click(Action action)
{
 ...
 * @param action Pointer to an action.
 */
public void btnCrewClick(Action action)
{
 ...
 * @param action Pointer to an action.
 */
public void btnEquipClick(Action action)
{
