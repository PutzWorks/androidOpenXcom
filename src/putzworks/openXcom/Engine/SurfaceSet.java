...
public class SurfaceSet
{
	...
	private Vector<Surface> _frames;
 ...
 */
public SurfaceSet(int width, int height)
{
	_width = width;
	_height = height;
	_frames = new Vector<Surface>();
 ...
 */
public SurfaceSet(final SurfaceSet other)
{
	_width = other._width;
	_height = other._height;

	for (int f = 0; f < other._frames.size(); f++)
	{
		_frames.add(new Surface(other._frames[f]));
	}
}
 ...
 */
public void loadPck(final String pck, final String tab)
{
	int nframes = 0;
 ...
 */
public void loadDat(final String filename)
{
	int nframes = 0;
 ...
 */
public final Surface getFrame(int i)
{
	return _frames[i];
}
